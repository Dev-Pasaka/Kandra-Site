...
import { ChariotScene } from "@/components/illustrations/chariot-scene";
  ...
  return (
    <div className="flex-1">
      <section className="relative overflow-hidden border-b border-border">
        <div className="relative mx-auto max-w-[1400px] px-4 md:px-6 pt-16 pb-10 md:pt-20 md:pb-12 grid grid-cols-1 lg:grid-cols-[1fr_460px] gap-10 items-center">
          <div>
          ...
          <div className="hidden lg:block text-ink-muted" aria-hidden="true">
            <ChariotScene className="w-full h-auto" />
          </div>
        </div>
      </section>
          ...
          {PAIN_POINTS.map((p) => (
            ...
            >
              <div className="flex items-start gap-3 mb-2.5">
                <span className="mt-0.5 inline-flex items-center justify-center w-7 h-7 shrink-0 rounded-md border border-border text-accent-strong group-hover:border-border-strong">
                  <p.icon className="w-[15px] h-[15px]" />
                </span>
                <h3 className="font-display font-semibold text-base leading-snug">{p.q}</h3>
              </div>
      ...
      <section className="border-t border-border bg-paper-raised/40">
        <div className="mx-auto max-w-[1400px] px-4 md:px-6 py-16 md:py-20 grid grid-cols-1 md:grid-cols-3 gap-10">
          <div>
            <PlugIcon className="text-accent-strong mb-3" />
          ...
          <div>
            <StartupFlagIcon className="text-accent-strong mb-3" />
          ...
          <div>
            <ScaleCostIcon className="text-accent-strong mb-3" />
