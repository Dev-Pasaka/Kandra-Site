...
<a href={dokkaModuleUrl("kandra-migrate")} target="_blank" rel="noreferrer"><code>kandra-migrate</code> on Dokka →</a> ·{" "}
<a href={dokkaClassUrl("kandra-migrate", "io.kandra.migrate", "KandraMigrationRunner")} target="_blank" rel="noreferrer"><code>KandraMigrationRunner</code> →</a>
