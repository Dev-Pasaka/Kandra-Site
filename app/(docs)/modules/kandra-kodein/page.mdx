...
<a href={dokkaModuleUrl("kandra-kodein")} target="_blank" rel="noreferrer"><code>kandra-kodein</code> on Dokka →</a> ·{" "}
<a href={dokkaClassUrl("kandra-kodein", "io.kandra.kodein", "KandraKodeinKt")} target="_blank" rel="noreferrer"><code>bindKandraRepository</code> →</a>
