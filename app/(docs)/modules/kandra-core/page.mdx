...
[`kandra-core` on Dokka →]({dokkaModuleUrl("kandra-core")}) ·
[`LookupIndex` →]({dokkaClassUrl("kandra-core", "io.kandra.core.annotations", "LookupIndex")}) ·
[`KandraConsistency` →]({dokkaClassUrl("kandra-core", "io.kandra.core", "KandraConsistency")}) ·
[`io.kandra.core.schema` package →]({dokkaPackageUrl("kandra-core", "io.kandra.core.schema")})
...
- [`/recipes/lookup-tables`](/recipes/lookup-tables), [`/recipes/soft-delete`](/recipes/soft-delete),
  ...
  task-oriented walkthroughs of the annotations on this page.
